...
SCHEMA: Dict[str, Tuple[str, str, bool, bool, str]] = {
    ...
    "BLOSSOM_MEMORY_EMBEDDING_API_KEY": ("BlossomMemory", "secret", False, True, "向量模型 API 密钥"),
    ...
    "BLOSSOM_MEMORY_RERANKER_API_KEY": ("BlossomMemory", "secret", False, True, "重排序 API 密钥"),
