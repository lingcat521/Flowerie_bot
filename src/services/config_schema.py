...
SCHEMA: Dict[str, Tuple[str, str, bool, bool, str]] = {
    ...
    "BLOSSOM_MEMORY_VECTOR_DIMENSION": ("BlossomMemory", "int", False, True, "向量维度", 64, 8192),
    "BLOSSOM_MEMORY_RETRIEVAL_TOP_K": ("BlossomMemory", "int", False, True, "检索 Top K", 1, 20),
    "BLOSSOM_MEMORY_RERANK_TOP_K": ("BlossomMemory", "int", False, True, "重排 Top K", 1, 10),
    "BLOSSOM_MEMORY_SIMILARITY_THRESHOLD": ("BlossomMemory", "float", False, True, "相似度阈值", 0.0, 1.0),
    "BLOSSOM_MEMORY_MAX_ENTRIES": ("BlossomMemory", "int", False, True, "每组记忆上限", 100, 100000),
    "BLOSSOM_MEMORY_TTL_DAYS": ("BlossomMemory", "int", False, True, "记忆 TTL（天，0=永久）", 0, 3650),
    "BLOSSOM_MEMORY_DAILY_EXTRACT_LIMIT": ("BlossomMemory", "int", False, True, "每日提取上限", 1, 500),
