...
BANNER = r"""
 ______ _      ______          ________ _____  _____ ______
|  ____| |    / __ \ \        / /  ____|  __ \|_   _|  ____|
| |__  | |   | |  | \ \  /\  / /| |__  | |__) | | | | |__
|  __| | |   | |  | |\ \/  \/ / |  __| |  _  /  | | |  __|
| |    | |___| |__| | \  /\  /  | |____| | \ \ _| |_| |____
|_|    |______\____/   \/  \/   |______|_|  \_\_____|______|
...
# 花璃的出场台词（随机一句）——严格贴人格设定：
#   「15~20 字以内 简洁自然 严禁话唠」「用空格代替逗号 不使用句号问号感叹号等标点符号」「不使用 emoji」
QUIPS = (
    "花璃来啦 今天也一起玩吧",
    "花璃在哦 有事随时叫我",
    "醒啦 群里有好玩的事吗",
