...
> 维护性更新：**无破坏性变更** —— 安全整改 + 原生多条回复 + Milky 能力补齐 + Web UI 修复 + 文档；
...
- **Web UI 平板 / 电脑排版修复（随 2.2.4 合入主线）**：外观页「卡片效果」与人格页「当前绑定」
...
> 维护性更新：**无破坏性变更**（版本号 2.2.2 -> 2.2.3；内容 = 2.2.2 + Web UI 排版修复）。

### 修复

- Web UI 平板 / 电脑排版：解除 row 嵌套（外观页「卡片效果」、人格页「当前绑定」）
